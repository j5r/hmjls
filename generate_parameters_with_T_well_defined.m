...
% returns a struct with the parameters of a well defined MMJLS.
%
% Struct = generate_parameters_with_T_well_defined(n_markov, sigma)
%
...
function Struct = generate_parameters_with_T_well_defined(n_markov, sigma)
if nargin == 1
    % from 0.2 to 10
